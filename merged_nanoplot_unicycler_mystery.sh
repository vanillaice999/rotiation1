...
#########################################
#barcode 01
unicycler -l --keep 0 barcode01/barcode01_merged.fastq.gz -o barcode01/unicycler_output/

#barcode 09
unicycler -l --keep 0 barcode09/barcode09_merged.fastq.gz -o barcode09/unicycler_output/

#barcode 10
unicycler -l --keep 0 barcode10/barcode10_merged.fastq.gz -o barcode10/unicycler_output/
